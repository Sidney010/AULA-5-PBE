            ...
            if (!validarDados) {
                ...
                if (result) {
                    ...
                    if (lastIdFilme) {
                        ...
                        // Processamento para insiri dados na tabela de relação
                        //Repertição para pegar cada genero e enviar para o DAO do filmeGenero
                        ...
                        // Processamento para trazer dados dos generos cadastrados na tablea de relação
